...
BOT_VERSION = "9.4"  # ← ubah satu baris ini saja saat rilis versi baru
...
#   3. MAX_OPEN_TRADES default 13→8: sesuai equity aktual ~$310.
...
# [v9.4] MAX_OPEN_TRADES default 13→8 sesuai equity aktual ~$310.
# $310/8 slot = ~$38 per posisi (vs $23 di 13 slot — fee menggerus terlalu besar).
# Override via env var MAX_OPEN_TRADES jika equity kembali naik.
...
def _run_tests() -> None:
    ...
    assert_true("SWING_ENABLED default = True",
                SWING_ENABLED)

    # MAX_OPEN_TRADES default 8 (sesuai equity ~$310)
