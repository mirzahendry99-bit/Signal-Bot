...
ETF_PREFIX = {
    "SOFI", "HOOD", "AFRM", "UPST",
    "RIVN", "LCID", "XPEV", "MRNA", "PLTR", "ABNB",
    "DKNG", "BYND", "DOCU", "ROKU", "SMCI", "IONQ", "ACHR", "JOBY",
}
...
def run():
    ...
    _dedup_memory  = {}   # [v7.7 #7] reset in-memory dedup setiap cycle
