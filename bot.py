...
def prefetch_candles_batch(client, pairs: list[str],
    ...
    Args:
        ...
        max_workers : jumlah thread paralel. Default 8 — sesuai rate limit Gate.io.
                      Terlalu banyak → rate limit 429. 8 adalah sweet spot.
...
def run():
    ...
    if _vol_pairs:
        ...
        _pf_stats = prefetch_candles_batch(client, _vol_pairs, max_workers=8)
