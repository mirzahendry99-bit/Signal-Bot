...
def check_swing(client, pair, price, fg, ob_ratio, funding,
    ...
    for side in ["BUY", "SELL"]:
        ...
        if is_bull:
            ...
            tp1 = price * 1.12  # FIX: tidak di-cap ke resistance (bisa < entry pada micro-cap)
            tp2 = price * 1.25  # FIX: tidak di-cap ke resistance
            ...
            tp1 = price * 0.88  # FIX: tidak di-cap ke support
            tp2 = price * 0.78  # FIX: tidak di-cap ke support
