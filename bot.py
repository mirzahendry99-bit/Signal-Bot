...
BOT_VERSION = "9.2.8" # ← ubah satu baris ini saja saat rilis versi baru
...
def build_equity_curve() -> dict:
    ...
    for row in rows:
        ...
        try:
            ...
            # [v9.2.8 fix] Exclude MICROCAP — pure alert, bukan managed trade.
            # 13/13 SL MICROCAP menggerus WR keseluruhan padahal tidak ada open trade.
