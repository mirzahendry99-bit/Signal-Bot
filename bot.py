"""
╔══════════════════════════════════════════════════════════════════╗
║        SIGNAL BOT — STABLE RELEASE v1.1                        ║
║                                                                  ║
...
def run():
    ...
    # Jangan hard-reset tiap cycle — menyebabkan 3 error berulang di setiap run.
    global _coinglass_fail_count, _coinglass_skip_until
    if time.time() > _coinglass_skip_until:
        _coinglass_fail_count = 0

    client = get_client()
    print(f"=== SIGNAL SCAN | STABLE v1.1 ===")
    ...
    tg(f"🔍 <b>Scan Selesai — STABLE v1.1</b>\n"
       f"━━━━━━━━━━━━━━━━━━\n"
