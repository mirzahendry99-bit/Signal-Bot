...
def detect_structure(closes, highs, lows, strength=3, lookback=80) -> dict:
    ...
    # BOS: deteksi apakah ada candle dalam 10 candle terakhir yang break level
    # Ini menangkap BOS yang sudah terjadi dan dikonfirmasi, bukan hanya candle saat ini
...
def check_swing(client, pair: str, price: float, ob_ratio: float,
    ...
    # Lebih realistis daripada EMA50>EMA200 yang sangat jarang terpenuhi di altcoin
