"""
╔══════════════════════════════════════════════════════════════════╗
║           SIGNAL BOT — CLEAN v7.21                              ║
║                                                                  ║
║  Perbaikan v7.21 (Growth Tuning Layer):                         ║
║                                                                  ║
║  [v7.21 #1] TARGET_RISK_PCT: 0.01 → 0.015                      ║
║             Risk per trade naik dari 1% ke 1.5% equity.         ║
║             Volatility scalar lebih agresif → vol_size naik.    ║
║             Portfolio heat estimasi naik ke 2–4% per trade.     ║
║             Cocok untuk akun yang sudah validasi beberapa cycle. ║
║                                                                  ║
║  [v7.21 #2] MIN_POSITION_USDT: 5 → 7                           ║
║             Floor minimum size naik → menghindari posisi         ║
║             terlalu kecil yang tidak bermakna secara kapital.    ║
║             Gate.io masih aman di angka ini untuk semua pair.    ║
║                                                                  ║
║  [v7.21 #3] CORR_SIZE_PENALTY: 0.50 → 0.30                     ║
║             Penalty korelasi dikurangi — pair dengan corr 0.85  ║
║             sekarang dapat size × 74.5% (sebelumnya × 57.5%).   ║
║             Portfolio exposure lebih efisien saat pasar trending. ║
║                                                                  ║
║  [v7.21 #4] Trend bias gate (SELL block)                        ║
║             portfolio_allows() Check 7 baru:                    ║
║             Jika regime == "TRENDING" dan struct == "BULLISH",  ║
║             signal SELL diblok secara otomatis.                  ║
║             Logika: melawan trend dominan = edge negatif.        ║
║             BUY dan SELL di RANGING/BEARISH tetap bebas.         ║
║                                                                  ║
